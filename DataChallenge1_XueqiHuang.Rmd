...
ggplot(data = milkcow_facts, # initialize ggplot object
       aes(x = avg_milk_cow_number, y = milk_production_lbs, color = year)) + 
  geom_point() + # scatter plot
  labs(x = 'Average number of milk cows',  # relabel x axis
       y = 'Total Milk production in pounds', # relabel y axis
